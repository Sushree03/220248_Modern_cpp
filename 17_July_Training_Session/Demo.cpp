...
{
    stackemployees.emplace_back(101,"Sushree",9000.0f,22,11.1f);
    stackemployees.emplace_back(102,"Shruti",5600.0f,21,12.1f);
...
{
    rawpointeremployees.emplace_back(new Employee(101,"Sushree",9000.0f,22,11.1f));
...
int main()
{
    ...
    std::cout<<"The name of employee with max experience is :"<<(*result1).name()<<"\n";
    ...
    std::cout<<"The name of employee with max experience is :"<<(*result2)->name()<<"\n";
}
